...
// 2 - ввод целого числа
// 3 - ввод целого числа от 1 до 5 
// 4 - ввод целого числа от 1 до 3 
// 5 - ввод целого числа от 1 до 7
// 6 - ввод года, 7 - месяца, 8 - дня, 9 - часов, 10 - минут
int correctInputk(int m, int b) {
  ...
  do {
    ...
    if (m == 3) {
      if (!(x >= 1 && x <= 5) && incorrectInput == false) {
        std::cout << "Некорректный ввод" << std::endl;
        incorrectInput = true;
      }
    }
